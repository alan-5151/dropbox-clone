class DropBoxCotroller {
  ...
  // método connectFirebase
  connectFirebase() {
    // Your web app's Firebase configuration
    // For Firebase JS SDK v7.20.0 and later, measurementId is optional
    var firebaseConfig = {
      apiKey: "AIzaSyBxmsyY6U9eiwWiw2CpweEXJ2cAFWfGG5Y",
      authDomain: "dropbox-clone-5151.firebaseapp.com",
      databaseURL: "https://dropbox-clone-5151-default-rtdb.firebaseio.com",
      projectId: "dropbox-clone-5151",
      storageBucket: "dropbox-clone-5151.appspot.com",
      messagingSenderId: "1020797147385",
      appId: "1:1020797147385:web:fc63fe8fe63c01b8f32a28",
      measurementId: "G-V1H0JE8WN8",
    };
    // Initialize Firebase
  ...
  height="160"
  viewBox="0 0 160 160"
  class="mc-icon-template-content tile__preview tile__preview--icon"
>
